function wenyuanChatRequest(prompt, systemMessage, stream, config, signal) {
    return new Promise((resolve, reject) => {
        console.log("wenyuan Request begin");
        const jwt = sJWT;
...
function wenyuanImgRequest(prompt) {
    return new Promise((resolve, reject) => {
        const jwt = window.Asc.JWT;
        console.log("Wenyuan image request begin");
